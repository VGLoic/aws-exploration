...
HEALTHCHECK --interval=10s CMD curl -f http://localhost:3000/health || exit 1

# Expose the port that the application listens on.
# Commented out because the port is not known at build time.
# EXPOSE 3000
